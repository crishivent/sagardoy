<section class="modulo-28">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <ul class="links">
            <li><a href="#gsomos" class="btn-link activo"><?php _e('Quiénes somos', 'sagardoy'); ?> </a></li>
            <li><a href="#greconocimiento" class="btn-link"><?php _e('Reconocimientos', 'sagardoy'); ?> </a></li>
